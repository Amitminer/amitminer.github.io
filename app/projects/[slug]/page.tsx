								...
								<div className="bg-slate-800/40 p-6 rounded-xl border border-slate-700/50">
									...
									<div className="space-y-4">
										<div className="relative pl-6 border-l-2 border-purple-500/30">
											<div className="absolute -left-1.25 top-1 w-3 h-3 bg-purple-500 rounded-full"></div>
										...
										{project.endDate && (
											<div className="relative pl-6 border-l-2 border-purple-500/30">
												<div className="absolute -left-1.25 top-1 w-3 h-3 bg-emerald-500 rounded-full"></div>
