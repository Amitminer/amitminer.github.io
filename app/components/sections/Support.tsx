		...
		>
			<div className="container mx-auto px-4 sm:px-6 text-center max-w-3xl">
              ...
              `}
						>
							<Heart
								className={`h-5 w-5 sm:h-6 sm:w-6 transition-transform duration-300 ${state.isHovered ? 'scale-110 text-pink-300' : ''
									}`}
							/>
							<span className="text-sm sm:text-base">Support My Work</span>
							<Coffee
								className={`h-4 w-4 sm:h-5 sm:w-5 transition-transform duration-300 ${state.isHovered ? 'scale-110 text-pink-300' : ''
									}`}
							/>
						</Button>
