// Social media and platform icons used throughout the application
...
export { SiDocker, SiAmazon, SiGooglecloud, SiGit } from 'react-icons/si';
export { SiArchlinux, SiGnubash } from 'react-icons/si';

export { FaWindows } from 'react-icons/fa';
